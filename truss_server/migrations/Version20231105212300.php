 ...
 */
final class Version20231105212300 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE text_channel_server (text_channel_id INT NOT NULL, server_id INT NOT NULL, INDEX IDX_6EC8039FEE0FA830 (text_channel_id), INDEX IDX_6EC8039F1844E6B7 (server_id), PRIMARY KEY(text_channel_id, server_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
