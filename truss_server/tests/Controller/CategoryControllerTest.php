...
class CategoryControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'category[textChannels]' => 'Testing',
            'category[voiceChannels]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'category[server]' => 'Something New',
            'category[textChannels]' => 'Something New',
            'category[voiceChannels]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getServer());
